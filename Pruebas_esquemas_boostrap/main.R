      ...
      print(resultados_ganadores)
        ...
        for (numEsquema in 1:length(resultadosInter)) {
          ...
          for (numIntervalo in 1:length(resultados_esquema)) {
            ...
            if (R2_intervalo == 1) {
              if (numIntervalo == 1) conteo_replica[numEsquema,IMatriz] <- conteo_replica[numEsquema,IMatriz] + 1
              if (numIntervalo == 2) conteo_replica[numEsquema,IMatriz +1] <- conteo_replica[numEsquema,IMatriz+1] + 1
              if (numIntervalo == 3) conteo_replica[numEsquema,IMatriz +2] <- conteo_replica[numEsquema,IMatriz+2] + 1
